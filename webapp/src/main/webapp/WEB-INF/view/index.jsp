...
<c:if test="${authenticatedUser != null}">
	<%
            ...
            BufferedReader reader = new BufferedReader(new FileReader(application.getRealPath("/")+"helptext"));
           ...
           String line;            while((line = reader.readLine())!= null){
            ...
            Random r = new Random();
            int index = Math.abs(r.nextInt()%textlist.size());
           out.println(textlist.get(index));
    	%>
</c:if>
